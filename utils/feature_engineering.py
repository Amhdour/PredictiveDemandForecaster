...
class FeatureEngineer:
    ...
    def encode_categorical_features(self, df):
        ...
        # Identify categorical columns (excluding date and target)
    ...
    def select_features(self, df, n_features=10):
        ...
        # Remove any remaining datetime or categorical columns
    ...
    def generate_features(self, df, include_lags=True, include_rolling=True):
        ...
        enhanced_df = self.encode_categorical_features(enhanced_df)
